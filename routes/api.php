...
Route::middleware(['auth:sanctum', 'abilities:user'])->group(function () {
    ...
    Route::prefix('pharmacy')->group(function () {
        Route::middleware('check_permission:stored-medicines')->prefix('stored-medicines')
        ...
        Route::middleware('check_permission:order-buy-medicines')
            ->controller(MedicinesBuyOrderController::class)->group(function () {
        ...
        Route::middleware('check_permission:sales-customers')->prefix('customers')
        ...
        Route::middleware('check_permission:employees')->prefix('employees')
        ...
        Route::middleware('check_permission:sales-customers')->prefix('sale-bills')
    ...
    Route::middleware('check_role:repository')->prefix('repository')->group(function () {
