...
use App\Http\Controllers\User\Pharmacy\MedicinesController;
...
Route::middleware(['auth:sanctum', 'abilities:frontuser'])->group(function () {
    ...
    Route::prefix('pharmacy')->group(function () {
        ...
        Route::prefix('medicines')->controller(MedicinesController::class)->group(function () {
            Route::get('get', 'getMedicines');
            Route::post('search', 'searchMedicines');
        });
        Route::prefix('stored-medicines')->controller(MedicinesController::class)->group(function () {
